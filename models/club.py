...
# -*- encodinng: uft-8 -*-
'''
Borrow from https://github.com/zylbuaa/PIBD/blob/main/models/club.py
@file: club.py
@author:zyl
...
class CLUBMean(nn.Module):  # Set variance of q(y|x) to 1, logvar = 0. Update 11/26/2022
    ...
    def _vec(self, t: torch.Tensor) -> torch.Tensor:  # GAP + flatten helper
    ...
    def forward(self, x_samples, y_samples):
        ...
        prediction_1 = mu.unsqueeze(1)  # shape [nsample,1,dim]
        y_samples_1 = y_vec.unsqueeze(0)  # shape [1,nsample,dim]
