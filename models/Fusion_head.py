...
class CNNHead(nn.Module):
    def __init__(self,
        ...
        self.CNN_fuse = nn.Sequential(
            nn.Conv2d(in_channels=embedding_dim * 8 + 6, out_channels=embedding_dim, kernel_size=3, stride=1,
                      padding=1),
    ...
    def forward(self, inputs, original_input):
        ...
        F_1_4_cat = torch.cat([F1_rgb_c, F1_ir_c, F2_rgb_c, F2_ir_c, F3_rgb_c, F3_ir_c, F4_rgb_c, F4_ir_c, ir_rgb_cat],
                              dim=1)
